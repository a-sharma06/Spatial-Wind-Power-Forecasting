...
for(j in 1:length(data.s1))
{
  ...
  for(i in 0:(length(data.s1[[j]]$speed["2011-04-01/2011-04-30"])-75))
  {
    a=i+1
    b=i+72
    ...
    point.forecast<-forecast(arima.auto.fit, h=3)$mean
    arima.s1[[count]][i+75]<-as.numeric(point.forecast)[3]
  }
  count<-count+1
}
  ...
  for(i in 0:(length(data.s1[[1]]$speed["2011-07-01/2011-07-31"])-75))
  {
    a=i+1
    b=i+72
...
for(j in 1:length(data.s2))
{
  ...
  for(i in 0:(length(data.s2[[j]]$speed["2011-04-01/2011-04-30"])-75))
  {
    a=i+1
    b=i+72
    example<-april$speed[a:b]
    ...
    arima.auto.fit <- auto.arima(example, stepwise=FALSE)
    point.forecast<-forecast(arima.auto.fit, h=3)$mean
    arima.s2[[count]][i+75]<-as.numeric(point.forecast)[3]
  }
  count<-count+1
}
...
for(i in 0:(length(data.s2[[1]]$speed["2011-07-01/2011-07-31"])-75))
{
  a=i+1
  b=i+72
  example<-july$speed[a:b]
...
for(j in 1:length(data.s9))
{
  ...
  for(i in 0:(length(data.s9[[j]]$speed["2011-04-01/2011-04-30"])-75))
  {
    a=i+1
    b=i+72
    example<-april$speed[a:b]
    ...
    arima.auto.fit <- auto.arima(example, stepwise=FALSE)
    point.forecast<-forecast(arima.auto.fit, h=3)$mean
    arima.s9[[count]][i+75]<-as.numeric(point.forecast)[3]
  }
  count<-count+1
}
...
for(i in 0:(length(data.s9[[1]]$speed["2011-07-01/2011-07-31"])-75))
{
  a=i+1
  b=i+72
  example<-july$speed[a:b]
...
for(j in 1:length(data.s10))
{
  ...
  for(i in 0:(length(data.s10[[j]]$speed["2011-04-01/2011-04-30"])-75))
  {
    a=i+1
    b=i+72
    example<-april$speed[a:b]
    ...
    arima.auto.fit <- auto.arima(example, stepwise=FALSE)
    point.forecast<-forecast(arima.auto.fit, h=3)$mean
    arima.s10[[count]][i+75]<-as.numeric(point.forecast)[3]
  }
  count<-count+1
}
...
for(i in 0:(length(data.s10[[1]]$speed["2011-07-01/2011-07-31"])-75))
{
  a=i+1
  b=i+72
  example<-july$speed[a:b]
